...
const char * const g_frameworkJSBuffer =
    ...
    "{s.forEach((function(e){var i=t[e];n(t,e,(function(){var n,s=Array.prototype.slice.call(ar"
    "guments);i.apply(this,s),r.PUSH===e||r.UNSHIFT===e?n=s:r.SPLICE&&(n=s.slice(2)),n&&n.lengt"
    "h&&n.forEach(o.of);var c=t.__ob__;c&&c.notifyParent()}))}))}(e),Object.keys(e).forEach((fu"
    "nction(n){return function(e,n,i){var r=e.__ob__;Object.defineProperty(e,n,{enumerable:!0,g"
    "et:function(){var e=t.top();e&&e.subscribe(r,n);var s=o.of(i);return o.is(s)&&s.setParent("
    "r,n),i},set:function(t){i=t,r.notify(n)}})}(e,n,e[n])}))}i.prototype._get=function(){try{r"
    ...
    "ent=function(){this._parent&&this._parent.notify(this._key)};var r={PUSH:'push',POP:'pop',"
    "UNSHIFT:'unshift',SHIFT:'shift',SPLICE:'splice',REVERSE:'reverse'},s=Object.keys(r).map((f"
    "unction(t){return r[t]}));function c(t){if(!(this instanceof c))return new c(t);var e=this"
    "._vm=this;'[object Object]'===Object.prototype.toString.call(t)&&Object.keys(t).forEach((f"
    "unction(n){var i=t[n];'render'===n?e.$render=i:'data'===n?function(t,e){'function'==typeof"
    " e&&(e=e.call(t,t));Object.keys(e).forEach((function(n){return function(t,e,n){Object.defi"
    "neProperty(t,n,{enumerable:!1,configurable:!0,get:function(){return e[n]},set:function(t){"
    "e[n]=t}})}(t,e,n)})),o.of(e)}(e,i):'styleSheet'===n?initStyleSheet(i):'function'==typeof i"
    "&&(e[n]=i.bind(e))}))}return c.prototype.$watch=function(t,e,n){return new i(this,t,e,n)},"
    "c}));";
#endif